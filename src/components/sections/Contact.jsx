    ...
    <section id="contact" className="section contact-section">
      <div className="container">
        <SectionHeader
          number="06"
          title="Contact"
          subtitle="Get in touch with KKN Group 8 Universitas Muhammadiyah Metro."
        />
        ...
        <div className="contact-content">
          ...
          >
            <h2 className="contact-headline">
             Get in Touch with KKN Group 8.{' '}
              <span className="gradient-text">remarkable together.</span>
            </h2>
            <p className="contact-desc">
              Feel free to contact KKN Group 8 regarding our work programs, educational activities, or collaboration with SMPN 8 Tulang Bawang.
            </p>
            ...
            <AnimatePresence mode="wait">
              {isSubmitted ? (
                ...
                >
                  ...
                  <span>Thank you! Your message has been sent successfully. KKN Group 8 will respond as soon as possible.</span>
                </motion.div>
              ) : (
                <motion.div
                  key="button"
