...
const floatingBadges = [
  { label: 'Motivation', emoji: '⚛️', x: '0%', y: '78%', delay: 1.5 },
  { label: 'Sturggle', emoji: '🟢', x: '48%', y: '0%', delay: 0.8 },
  { label: 'Collaboration', emoji: '🍃', x: '-20%', y: '25%', delay: 1.6 },
  { label: 'Dedication', emoji: '🔷', x: '87%', y: '40%', delay: 1.2 },
  { label: 'Unity', emoji: '🟡', x: '90%', y: '85%', delay: 1.0 },
];
      ...
      <div className="container hero-content">
        ...
        >
          ...
          >
            ...
            <span className="mono">KKN/PLP Batch 2026</span>
          </motion.div>

          <h1 className="hero-name text-xs">
            <AnimatedText text="KKN-PLP 8 Mulya Kencana UMMetro Tubaba " delay={0.2} />
          </h1>
          ...
          >
            KKN Kelompok 8 berkomitmen memberikan kontribusi nyata melalui inovasi di bidang pendidikan, pemberdayaan masyarakat, serta pelaksanaan program-program kolaboratif bersama SMPN 8 Tulang Bawang demi mewujudkan dampak yang bermakna dan berkelanjutan. 🌍
          </motion.p>
              ...
              <AnimatePresence mode="wait">
                {showPhoto ? (
                  ...
                  <motion.div
                    ...
                    exit="exit"
                  >
                    <span className="hero-avatar-initials">KKN 8</span>
                    <div className="hero-avatar-subtitle">
                      <span className="mono">KKN Group 8</span>
                      <span className="hero-avatar-location">
                        <span className="gradient-text">SMPN 8 Tulang Bawang</span>
                        <span className="mono">TBB</span>
                      </span>
                    </div>
                  </motion.div>
                )}
